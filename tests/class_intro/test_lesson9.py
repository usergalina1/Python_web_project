# interview question Lesson 9 from 58 min

'''
function takes params:list $ int
...
def is_there_sum_of_two_numbers(ls: list, total: int):
    ...
    #             break
    #     else:
    #         print('inner match not found')
    # else:
    #     print('outer match not found')
    # print("*" * 12)
    return result
...
def count_matching_pairing(ls: list, total: int):
    result = 0
    for i in range(len(ls)):
        # ls[i]
        for x in range(i + 1, len(ls)):
...
assert efficient2_matching_pair([3, 5, 3, 17], 8) == True
assert efficient2_matching_pair([3, 5, 3, 17], 22) == True
assert efficient2_matching_pair([3, 5, 3, 17], 17) == False

assert efficient2_matching_pair([3, 5, 3, 17], 11) == False
assert efficient2_matching_pair([2, 2, 2, 2, 2, 2, 2, 2], 4) == True
assert efficient2_matching_pair([2, 3, 4, 5], 4) == False